...
* The original package name 'co.mkabir.rest.webservices.restful-web-services' is invalid and this project uses 'co.mkabir.rest.webservices.restfulwebservices' instead.
